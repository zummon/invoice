...
<div class="flex flex-wrap justify-center px-2 py-4 lg:py-6 gap-4 print:hidden">
  <button class="text-green-500 cursor-pointer" title="Add a new row" onclick={() => { 
		qry.price.push(''); 
		qry.qty.push(''); 
		qry.desc.push(''); 
	}}>
  ...
  <button class="text-neutral-500 cursor-pointer" title="Clear forms" onclick={() => { clear() }}>
  ...
  <button class="text-cyan-500 cursor-pointer" title="Copy" onclick={() => { done(); }}>
